...
// Must be rendered inside a Router context (e.g. RootLayout)
export function MenuDrawerSheet() {
  ...
  return (
    <div className="fixed inset-0 z-[60] flex justify-end">
      ...
      <aside
        className={[
          'relative flex h-full w-[min(88vw,320px)] flex-col gap-4 overflow-y-auto p-4 shadow-2xl ring-1',
          sheetBg,
        ].join(' ')}
      >
        ...
        <nav className="flex flex-col gap-1 text-sm">
          <Link
            to="/"
            className="rounded-xl px-3 py-2 ring-1 ring-black/10 hover:bg-black/[0.04] dark:ring-white/15 dark:hover:bg-white/10"
            onClick={closeMenu}
          >
            {t(locale, 'navCatalog')}
          </Link>
